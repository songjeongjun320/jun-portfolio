  ...
  logs: [
    {
      ...
      date: '2025-07-30',
      summary: 'Deployed 6 new MCP server tools for advanced project analysis and reporting.',
      details:
        `Expanded the MCP server's capabilities with a suite of 6 new tools designed to provide deep insights into project management, powered by Gemini for AI analysis.
...
- **\`milestone_tracking\`**: Tracks project milestones and key achievements.`,
      ...
      links: [{ label: 'MCP PR #1', href: 'https://github.com/atoms-tech/atoms.tech/pull/1' }]
    },
    {
      id: 'atoms-2025-07-30-pr227',
      date: '2025-07-30',
      summary: 'Fixed a UI overlap issue between the Agent Chat toggle and the Edit Mode button.',
      details:
        `Resolved a z-index and positioning conflict at the bottom-right of the screen.
...
- **Layout Integration:** On larger screens, the main content area now resizes to make space for the agent panel, preventing the panel from obscuring content. On mobile, the overlay behavior is maintained for a better UX.`,
      ...
      links: [{ label: 'PR #227', href: 'https://github.com/atoms-tech/atoms.tech/pull/227' }]
    },
    {
      id: 'atoms-2025-07-23-pr206',
      date: '2025-07-23',
      summary: 'Implemented a message queue in the Agent Chat to handle multiple simultaneous messages.',
      details:
        `Enhanced the agent chat with a queueing system, allowing users to send multiple messages without waiting for a response to each one. This significantly improves productivity and conversation flow.
...
- **UI Relocation:** Moved the agent panel to the bottom-right corner for better screen real estate management.`,
      ...
      links: [{ label: 'PR #206', href: 'https://github.com/atoms-tech/atoms.tech/pull/206' }]
    },
    {
      id: 'atoms-2025-07-20-pr195',
      date: '2025-07-20',
      summary: 'Major UI overhaul for the chat panel and other application components.',
      details:
        `A significant visual refresh was implemented, focusing on the chat panel and overall UI consistency.
...
- **Default State:** The agent panel now defaults to a closed state on page load.`,
      ...
      links: [{ label: 'PR #195', href: 'https://github.com/atoms-tech/atoms.tech/pull/195' }]
    },
    {
      id: 'atoms-2025-07-13-pr185',
      date: '2025-07-13',
      summary: 'Enhanced the Agent Chat to support organization-specific conversation history.',
      details:
        `Upgraded the chat system to isolate conversation history for each organization, creating a more contextual and organized user experience.
...
- **Resizable Panel:** The chat panel width is now user-resizable.`,
      ...
      links: [{ label: 'PR #185', href: 'https://github.com/atoms-tech/atoms.tech/pull/185' }]
    },
    {
      id: 'atoms-2025-07-12-pr184',
      date: '2025-07-12',
      summary: 'Added keyboard shortcuts for the Agent Panel (Ctrl+L) and Help Dialog (Ctrl+/).',
      details:
        `Improved user workflow and accessibility by refining the application's keyboard shortcuts.
...
- **Changed:** The help dialog shortcut was changed from \`Shift + ?\` to \`Ctrl + /\` to avoid conflicts with typing the '?' character.`,
      ...
      links: [{ label: 'PR #184', href: 'https://github.com/atoms-tech/atoms.tech/pull/184' }]
    },
    {
      id: 'atoms-2025-07-10-pr176',
      date: '2025-07-10',
      summary: 'Introduced a full-featured AI Agent Chat system with N8N and voice integration.',
      details:
        `Launched a major new feature: an AI-powered chat agent. This system provides real-time assistance and is integrated with both a local AI and external N8N workflows.
...
- **Secure Context:** Safely passes user, organization, and project context to the AI agent.`,
      ...
      links: [{ label: 'PR #176', href: 'https://github.com/atoms-tech/atoms.tech/pull/176' }]
    },
    {
      id: 'atoms-2025-06-27-pr108',
      date: '2025-06-27',
      summary: 'Fixed UI bug causing long document names to overflow their containers.',
      details:
        `Resolved a visual bug on the Regulation Documents page where long filenames would break the layout.
...
- Improved the Flexbox layout to ensure responsive and consistent behavior.`,
      ...
      links: [{ label: 'PR #108', href: 'https://github.com/atoms-tech/atoms.tech/pull/108' }]
    },
    {
      id: 'atoms-2025-06-17-pr97',
      date: '2025-06-17',
      summary: 'Updated navigation flow to show "Projects" or "Requirements" tab by default.',
      details:
        `Adjusted the default navigation behavior for better user workflows.
...
- This aligns the initial view with the most common user tasks, improving efficiency.`,
      ...
      links: [{ label: 'PR #97', href: 'https://github.com/atoms-tech/atoms.tech/pull/97' }]
    },
    {
      id: 'atoms-2025-06-17-pr95',
      date: '2025-06-17',
      summary: 'Fixed a persistent bug where refreshing would reset the active tab on dashboard pages.',
      details:
        `Resolved a major UX issue by synchronizing the active tab state with URL search parameters (\`?currentTab=...\`). This ensures tab state persists across refreshes and allows for shareable, context-specific URLs.
...
- **Consistency:** Applied the fix across all dashboards: Organization, Project, and User.`,
      ...
      links: [{ label: 'PR #95', href: 'https://github.com/atoms-tech/atoms.tech/pull/95' }]
    },
    {
      id: 'atoms-2025-06-11-pr86',
      date: '2025-06-11',
      summary: 'Implemented a comprehensive cross-browser testing framework using Playwright.',
      details:
        `Established a robust automated testing foundation to ensure application consistency across multiple browsers and devices.
...
- **Tooling & CI/CD:** Integrated Jest for unit tests, helper utilities, and a compatibility matrix generator. The framework is ready for CI/CD integration with GitHub Actions.`,
      ...
      links: [{ label: 'PR #86', href: 'https://github.com/atoms-tech/atoms.tech/pull/86' }]
    }
  ]
};
