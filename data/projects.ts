export const projects = [
  {
    ...
    description:
      'HackAgent 2025 Winner: AI-powered voice assistant transforming healthcare workflows. Features instant patient summaries, voice-to-structured notes, real-time schedule integration, and voice-driven automation. Built with Next.js 15, TypeScript, Web Speech API, and N8N workflow automation.',
