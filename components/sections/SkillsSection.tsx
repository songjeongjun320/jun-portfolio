...
import { SiPython, SiJavascript, SiTypescript, SiNextdotjs, SiReact, SiFlask, SiN8N, SiSupabase, SiGit, SiAmazon, SiLinux, SiOpenai, SiHuggingface } from 'react-icons/si';
import { FaRobot, FaArrowLeft, FaDatabase, FaCode, FaServer, FaCogs, FaUser, FaBrain, FaGem } from 'react-icons/fa';
  ...
  const techStacks = {
    ...
    backend: {
      ...
      skills: [
        ...
        { name: 'Node.js', icon: <span className="text-[clamp(1.2rem,2.5vw,2rem)] text-green-600">⬢</span> },
      ],
    },
    database: {
    ...
    automation: {
      ...
      skills: [
        { name: 'AI Agent Tool', icon: <FaRobot className="text-[clamp(1.2rem,2.5vw,2rem)] text-indigo-500" /> },
        { name: 'n8n', icon: <SiN8N className="text-[clamp(1.2rem,2.5vw,2rem)] text-[#EF7C28]" /> },
        { name: 'Langchain', icon: <span className="text-[clamp(1.2rem,2.5vw,2rem)] text-green-500">🔗</span> },
      ],
    },
    aiml: {
      ...
      skills: [
        { name: 'OpenAI', icon: <SiOpenai className="text-[clamp(1.2rem,2.5vw,2rem)] text-black" /> },
        { name: 'Claude AI', icon: <FaBrain className="text-[clamp(1.2rem,2.5vw,2rem)] text-orange-500" /> },
        { name: 'Gemini', icon: <FaGem className="text-[clamp(1.2rem,2.5vw,2rem)] text-blue-500" /> },
        { name: 'Llama', icon: <FaRobot className="text-[clamp(1.2rem,2.5vw,2rem)] text-purple-600" /> },
        { name: 'HuggingFace', icon: <SiHuggingface className="text-[clamp(1.2rem,2.5vw,2rem)] text-yellow-500" /> },
        { name: 'YOLOv5~10', icon: <FaRobot className="text-[clamp(1.2rem,2.5vw,2rem)] text-blue-400" /> },
      ],
    },
  };
...
function TechStackCard({
  ...
  if (layout === "custom-2-1") {
    return (
      <CSSTransition in={true} timeout={500 + delay} classNames="fade" unmountOnExit>
        <div 
