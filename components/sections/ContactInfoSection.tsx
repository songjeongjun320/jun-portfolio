...
export default function ContactInfoSection({ onBack }: ContactInfoSectionProps) {
  ...
  const content = [
    { label: 'Email', link: 'mailto:songjeongjun320@gmail.com', icon: 
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" style={{ width: 'clamp(3rem,6vw,5rem)', height: 'clamp(3rem,6vw,5rem)' }}>
    ...
    { label: 'LinkedIn', link: 'https://www.linkedin.com/in/junsong0602', icon: <FaLinkedin className="text-[clamp(3rem,6vw,5rem)] text-blue-600" /> },
    { label: 'GitHub', link: 'https://github.com/songjeongjun320', icon: <FaGithub className="text-[clamp(3rem,6vw,5rem)] text-gray-800" /> },
    { label: 'X', link: 'https://x.com/jsong132', icon: <FaXTwitter className="text-[clamp(3rem,6vw,5rem)] text-black" /> },
  ];
